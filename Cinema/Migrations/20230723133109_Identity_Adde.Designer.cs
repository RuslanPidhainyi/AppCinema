...
namespace AppCinema.Migrations
{
    ...
    [Migration("20230723133109_Identity_Adde")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppCinema.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AppCinema.Models.Cinema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppCinema.Models.Actor_Movie", b =>
                {
                    b.HasOne("AppCinema.Models.Actor", "Actor")
            ...
            modelBuilder.Entity("AppCinema.Models.Movie", b =>
                {
                    b.HasOne("AppCinema.Models.Cinema", "Cinema")
                        .WithMany("Movies")
                        .HasForeignKey("CinemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppCinema.Models.Producer", "Producer")
                        .WithMany("Movies")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AppCinema.Models.ApplicationUser", null)
                        .WithMany()
